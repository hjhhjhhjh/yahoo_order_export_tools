(function () {
    ...
    //     "商品子编号": "subCode",
    //     "商品属性": "itemOption",
    //     "收件电话": "shipPhoneNumber",
    //     "收件人": "shipLastName+shipFirstName",
    //     "收件邮编": "shipZipCode",
    //     "收件人地址": "shipPrefecture+shipCity+shipAddress1+shipAddress2",
    //     "物品数量": "quantity",
    //     "单价金额": "unitPrice",
    //     "金额": "lineTotalPrice",
    //     "订单总价": "totalPrice",
    ...
    var columns = {
        ...
        "收件人":"shipLastName+shipFirstName",
        "收件单位(空)":"",
        "收件地址":"shipPrefecture+shipCity+shipAddress1+shipAddress2",
        "收件邮编":"shipZipCode",
        "收件电话":"shipPhoneNumber",
    ...
    gotoShowData = function () {
        ...
        data.forEach((obj, objIndex) => {
            ...
            //     +"住所"
            //     +"<br />"
            //     +obj.shipPrefecture+obj.shipCity+obj.shipAddress1+obj.shipAddress2
            //     +"<br />"
            //     +"<br />"
            //     +"電話番号"
            //     +"<br />"
            ...
            myFullShipAddress="氏名 "
                ...
                +"電話番号 "
                +obj.shipPhoneNumber;
            obj.myFullShipAddress=myFullShipAddress;
